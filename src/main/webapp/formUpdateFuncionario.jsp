...
<title>Wallz Tour - Alterar Funcionário</title>
    	...
    	<section>
     	   <div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						<hr>
						<h3 class="titulo-aba d-flex justify-content-center">Alterar dados do funcionário</h3>
						<hr>
						<form action="FuncionarioUpdate" method="POST">
							<input value="${funcionario.idFuncionario}" name="idFuncionario" style="visibility:hidden">
							<div class="py-2">
									<label>Nome completo</label>
									<input value="${funcionario.nome}" name="nome" maxlength="300" type="text" class="form-control" id="floatingInput1"> 
							</div>
							<div class="py-2">
									<label>E-mail</label>
									<input value="${funcionario.email}" name="email" maxlength="150" type="text" class="form-control" id="floatingInput2"> 
							</div>
							<div class="py-2">
									<label>Senha</label>
									<input value="${funcionario.senha}" name="senha" maxlength="50" type="password" class="form-control" id="floatingInput3"> 
							</div>
							<div class="py-2">
								<label>Registro da Matrícula (apenas números)</label>
								<input value="${funcionario.registroMatricula}" name="registroMatricula" min="0" max="999999" type="number" class="form-control" id="floatingInput4"> 
							</div>
							<div class="d-flex justify-content-center py-3">
								<select class="form-control" name="perfil">
									<option value="${funcionario.perfil}" selected> Atualmente o perfil é de ${funcionario.perfil} </option>
