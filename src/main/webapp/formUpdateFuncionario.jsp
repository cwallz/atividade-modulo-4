				...
				<div class="row d-flex align-items-center justify-content-center">
					<div class="col-md-7">
						...
						<form action="FuncionarioUpdate" method="POST">
							...
							<div class="py-2">
									<label>E-mail</label>
									<input value="${funcionario.email}" name="email" maxlength="150" type="text" class="form-control" id="floatingInput1"> 
							</div>
							<div class="py-2">
									<label>Senha</label>
									<input value="${funcionario.senha}" name="senha" maxlength="50" type="password" class="form-control" id="floatingInput1"> 
							</div>
							<div class="py-2">
								<label>Registro da Matrícula (apenas números)</label>
								<input value="${funcionario.registroMatricula}" name="registroMatricula" maxlength="6" type="text" class="form-control"> 
							</div>
